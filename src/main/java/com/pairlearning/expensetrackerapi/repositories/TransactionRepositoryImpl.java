...
public class TransactionRepositoryImpl implements TransactionRepository {
  ...
  private static final String SQL_CREATE = "INSERT INTO ET_TRANSACTIONS (TRANSACTION_ID,"
      + " CATEGORY_ID, USER_ID, AMOUNT, NOTE, TRANSACTION_DATE)" +
      " VALUES(NEXTVAL('ET_TRANSACTIONS_SEQ'), ?, ?, ?, ?, ?)";

  private static final String SQL_FIND_ID = "SELECT TRANSACTION_ID, CATEGORY_ID, USER_ID"
  ...
  public Transaction findById(Integer userId, Integer categoryId, Integer transactionId)
    ...
    try {
      return jdbcTemplate.queryForObject(SQL_FIND_ID, new Object[] { userId, categoryId, transactionId },
  ...
  @Override
  public Integer create(Integer userId, Integer categoryId, Double amount, Long transactionDate,
